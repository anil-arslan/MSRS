...
detector = detectorNoncoherent( ...
    ...
    "SNR_input_dB", flipud(linspace(10, 0, 30).'), ...
    ..."SNR_input_dB", 6, ...
...
detector.setalgorithm("globalFusionRule", "BC", "numberOfBinaryDetectionsRule", "fixedGlobalPFA");
...
% Local thresholding de optimum rule nedir? GLRT LRT
% EGC optimum mudur?
